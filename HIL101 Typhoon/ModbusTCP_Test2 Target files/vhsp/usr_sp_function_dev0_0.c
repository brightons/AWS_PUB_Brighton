...
double _constant3__out = 1.0;
double _constant4__out = 1.0;
double _modbus_device1_comp_coil_in_out__out;
double _modbus_device1_comp_holding_in_out__out;
//@cmp.var.end
...
void TimerCounterHandler_0_user_sp_cpu0_dev0() {
    ...
    _bus_join1__out[0] = _constant2__out;
    _bus_join1__out[1] = _constant3__out;
    _bus_join1__out[2] = _constant4__out;
    ...
    // Component not supported for this platform. Outputs are zeroed.
    _modbus_device1_comp_holding_in_out__out = 0;
